...
@implementation MPVolumeButtons
...
static void volumeListenerCallback (
    ...
    if (volume > [(__bridge MPVolumeButtons*)inClientData launchVolume])
    {
        [(__bridge MPVolumeButtons*)inClientData volumeUp];
    }
    else if (volume < [(__bridge MPVolumeButtons*)inClientData launchVolume])
    {
        [(__bridge MPVolumeButtons*)inClientData volumeDown];
    }
}
